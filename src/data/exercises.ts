  ...
  cardio: [
    {
      ...
      instructions: [
        ...
        "Start at a steady walk (3-4 mph) to warm up for 5 minutes.",
        "Increase speed to a jog (5-7 mph) or high intensity run.",
        "Maintain upright posturing, pumping arms comfortably at your sides.",
        "Slow down gradually to a walk for a cool-down block before stepping off."
      ]
    },
    {
      ...
      pool: "cardio",
      instructions: [
        "Adjust seat height so your knees have a slight bend at the bottom of the pedal stroke.",
        "Pedal at moderate resistance for a few minutes to warm up.",
        "Alternate between 30-second all-out sprint bursts and 60-second recovery intervals.",
        "Keep your shoulder relaxed and drive the power from your glutes and quads."
      ]
    },
    {
      ...
      pool: "cardio",
      instructions: [
        "Secure your feet in the straps and grasp the handle with fingers wrapped over.",
        "Drive with your legs first, then lean back slightly and pull the handle to your lower ribs.",
        "Return your arms, hinge your torso forward, then bend your knees to slide back.",
        "Aim for a consistent stroke rate and drive powerfully with each rep."
      ]
    },
    {
      name: "Burpees",
      ...
      pool: "cardio",
      instructions: [
        "Stand tall, then drop into a squat position placing your hands on the floor.",
        "Jump your feet back into a push-up/plank stance and lower your chest to the ground.",
        "Push up and jump your feet back in toward your hands.",
        "Explode vertically into a jump, reaching your hands overhead."
      ]
    },
    {
      name: "Jumping Jacks",
      ...
      instructions: [
        ...
        "Jump wide with your feet while lifting both hands out and overhead.",
        "Jump back to the original position, lowering hands to sides.",
        "Repeat at a clean and snappy rhythm to elevate your heart rate."
      ]
    },
    {
      ...
      pool: "cardio",
      instructions: [
        "Begin in a solid high-plank position with wrists directly under shoulders.",
        "Drive one knee forward toward your chest, then switch quickly in mid-air.",
        "Keep your hips low and run your knees in and out under control.",
        "Maintain a flat back and active core engagement throughout."
      ]
    },
    {
      name: "Treadmill Hike",
      ...
      pool: "cardio",
      instructions: [
        "Step onto the treadmill and set the incline to a steep gradient (e.g., 8-12%).",
        "Set the speed to a challenging walk (e.g., 2.5-3.5 mph).",
        "Focus on driving through your heels and engaging your glutes and calves.",
        "Avoid holding onto the handrails to maximize core engagement and caloric burn.",
        "Pace yourself and breathe deeply, maintaining upright posture throughout."
      ]
    }
  ],
  equipment: [
    {
      ...
      instructions: [
        "Stand over the kettlebell with feet slightly wider than shoulder-width.",
        "Hinge at your hips, gripping the handle firmly with both hands.",
        "Pull the kettlebell back between your legs, then drive your hips forward explosively.",
        "Let the kettlebell swing up to chest height naturally, squeezing your glutes.",
        "Hinge back down to catch the bell and repeat in one fluid motion."
      ]
    },
    {
      ...
      instructions: [
        ...
        "Set feet slightly wider than shoulder-width apart.",
        "Lower your hips down and back, passing parallel if possible.",
        "Drive back up using your legs, staying upright throughout."
      ]
    },
    {
      ...
      equipmentCategory: "Kettlebells",
      instructions: [
        "Lie flat on the ground holding the kettlebell in one hand straight up.",
        "Bend the knee on the same side and place your foot flat.",
        "Roll onto your elbow, then push up onto your hand.",
        "Bridge your hips high and sweep your straight leg underneath to a kneeling stance.",
        "Stand up fully while keeping your arm locked straight overhead."
      ]
    },
    {
      ...
      instructions: [
        ...
        "Hinge at the hips, clean the kettlebell to your shoulder by popping your hips and catching it in the rack position.",
        "Press the kettlebell overhead by driving through your shoulder, keeping your core engaged and arm locked at the top.",
        "Lower the kettlebell back to the rack position under control, then guide it down to the floor between your legs."
      ]
    },
    {
      ...
      instructions: [
        ...
        "Hinge at the hips, swing the kettlebell backward between your legs, then drive explosively through your hips.",
        "Pull the kettlebell upward, keeping it close to your body, punching your hand through the loop at the top to lock it out hand-overhead.",
        "Keep your wrist straight and stabilize your shoulder before repeating the swing movement."
      ]
    },
    {
      ...
      instructions: [
        "Hold TRX handles facing the anchor point, and lean back at a comfortable angle.",
        "Keep your body entirely straight like a plank, heels dug into the ground.",
        "Pull your chest up toward the handles by retracting your shoulder blades.",
        "Lower yourself back down under control, extending your arms fully."
      ]
    },
    {
      ...
      equipmentCategory: "TRX",
      instructions: [
        "Grasp TRX handles and face away from the anchor point with feet hip-width.",
        "Lean forward into a plank, arms extended straight ahead.",
        "Lower your chest down by bending your elbows (similar to a push-up).",
        "Press back up to straighten your arms, keeping straps clear of your shoulders."
      ]
    },
    {
      ...
      equipmentCategory: "TRX",
      instructions: [
        "Place one foot in the TRX foot cradle facing away from the anchor.",
        "Take a step forward with your working leg.",
        "Lower your hips down into a deep lunge position, sliding the rear leg backward.",
    ...
    },
    {
      ...
      equipmentCategory: "TRX",
      instructions: [
        "Stand facing away from the anchor point, holding the TRX handles with an overhand grip at chest height.",
        "Lean forward into a strong plank, arms straight in front of you.",
        "Slowly raise your arms up overhead, allowing your body to fall forward while keeping your core completely locked.",
        "Press down through your hands to return your arms and body to the starting position."
      ]
    },
    {
      ...
      equipmentCategory: "TRX",
      instructions: [
        "Lie on your back and place your heels securely inside the TRX foot cradles.",
        "Lift your hips off the ground, forming a straight line from your shoulders to your knees.",
        "Pull your heels toward your glutes by bending your knees, keeping your hips elevated and stable.",
        "Slowly extend your legs back out to the starting position with control."
      ]
    },
    {
      ...
      instructions: [
        "Hold one end of the battle rope in each hand with a firm, handshake grip.",
        "Get into a quarter-squat stance, keeping your spine neutral and chest up.",
        "Raise and lower both arms together rapidly to create smooth waves in the ropes.",
        "Sustain this high-intensity pace for the target duration."
      ]
    },
    {
      ...
      instructions: [
        ...
        "Lift both arms high above your head, rising slightly onto your toes.",
        "Slam the ropes into the floor with maximum force, bending your knees to squat.",
        "Return immediately and repeat with powerful effort."
      ]
    },
    {
      ...
      equipmentCategory: "Battle Ropes",
      instructions: [
        "Hold a rope in each hand, assuming a balanced athletic quarter-squat stance.",
        "Lift one arm up while lowering the other, alternating rapidly to create a continuous wave pattern in each rope.",
        "Maintain a high tempo, keeping your core solid and chest up.",
        "Keep your shoulders retracted and minimize torso movement."
      ]
    },
    {
      name: "Battle Rope In-and-Out Waves",
      icon: "ArrowLeftRight",
      pool: "equipment",
      equipmentCategory: "Battle Ropes",
      instructions: [
        "Assume a quarter-squat stance holding the ends of the battle ropes.",
        "Move both arms in and out horizontally (like a chest fly) in a rapid, snapping rhythm.",
        "Generate circular waves that move inward and outward along the floor.",
        "Squeeze your chest and upper back with each horizontal beat."
      ]
    },
    {
      ...
      instructions: [
        "Anchor a resistance band at forehead height.",
        "Grasp the band with an overhand grip and step back to create tension.",
        "Pull the band toward your nose, flaring your elbows high and wide.",
        "Squeeze your upper back/rear deltoids, then slowly slide back."
      ]
    },
    {
      ...
      equipmentCategory: "Resistance Bands",
      instructions: [
        "Hold a resistance band directly in front of you at shoulder height with straight arms.",
        "Pull your hands apart to stretch the band out until it touches your chest.",
        "Squeeze your shoulder blades together firmly.",
        "Slowly bring your hands back together under tension."
      ]
    },
    {
      ...
      equipmentCategory: "Resistance Bands",
      instructions: [
        "Stand on the middle of a continuous heavy loop resistance band with feet shoulder-width.",
        "Hold the other end of the band at your shoulders with palms facing forward.",
        "Perform a deep squat, keeping your knees pushed out and chest held high.",
        "Drive backward up to a stand, and simultaneously press the band overhead until arms are locked."
      ]
    },
    {
      ...
      equipmentCategory: "Resistance Bands",
      instructions: [
        "Anchor a resistance band to a vertical post at shoulder-height.",
        "Stand sideways to the anchor point, holding the band handle in both hands.",
        "Pull the band across and down your body in a sweeping woodchopping movement, pivoting your back foot.",
        "Rotate from your thoracic spine and squeeze your obliques as you execute the motion."
      ]
    },
    {
      ...
      instructions: [
        "Stand with feet shoulder-width, holding the slam ball on the floor.",
        "Clean the ball up, reaching it high above your head.",
        "Slam the ball directly into the floor between your feet using your core.",
        "Catch the ball on the rebound or retrieve it quickly and repeat."
      ]
    },
    {
      name: "Slam Ball Rotational Toss",
      icon: "RotateCw",
      pool: "equipment",
      equipmentCategory: "Slam Balls",
      instructions: [
        "Stand sideways in front of a solid wall, holding the slam ball.",
        "Pivot your hips and rotate your torso to throw the ball underhand against the wall.",
        "Catch the ball on the bounce and repeat rapidly for all reps."
      ]
    },
    {
      ...
      equipmentCategory: "Slam Balls",
      instructions: [
        "Stand over a heavy slam ball. Scoop it up and hold/hug it tightly against your chest.",
        "Position your feet slightly wider than shoulder-width, toes angled slightly out.",
        "Sit your hips back and squat down deeply, maintaining a high, strong chest.",
        "Drive high through your heels to return to standing, keeping the ball clutched closely."
      ]
    },
    {
      name: "Slam Ball Chest Pass to Floor",
      icon: "ArrowDown",
      pool: "equipment",
      equipmentCategory: "Slam Balls",
      instructions: [
        "Stand tall with feet hip-width apart, holding the slam ball at chest height with both hands.",
        "Push and press the ball downward explosively, throwing it into the ground directly in front of you.",
        "Squeeze your chest and triceps hard at the bottom of the pass.",
        "Squat to lift the ball back up and repeat with intensity."
      ]
    },
    {
      ...
      instructions: [
        "Hold a weight plate flat in both hands and lock your arms out straight overhead.",
        "Keep your core zipped and step forward into a lunge.",
        "Alternate legs, ensuring the plate remains securely locked overhead."
      ]
    },
    {
      ...
      equipmentCategory: "Weight Plates",
      instructions: [
        "Stand with feet wide, holding a weight plate flat on the floor.",
        "Squeeze your core, hinge down, then lift the plate cleanly up and overhead.",
        "Lower back down to the floor in a controlled squat/hinge motion."
      ]
    },
    {
      name: "Plate Halo",
      ...
      equipmentCategory: "Weight Plates",
      instructions: [
        "Stand tall, holding a weight plate by its sides at chest height.",
        "Orbit the plate tightly around your head in a full circle, moving it behind your neck and back to your chest.",
        "Keep your neck relaxed, core tight, and minimize head movement.",
        "Alternate the direction of the halos with each repetition."
      ]
    },
    {
      ...
      equipmentCategory: "Weight Plates",
      instructions: [
        "Sit on the floor with knees bent and feet elevated slightly off the ground, forming a V-shape with your torso.",
        "Hold a weight plate flat in both hands over your lap.",
        "Rotate your torso to guide the plate to one side of your hip, twisting your chest.",
        "Rotate in the opposite direction to touch the plate near the other hip."
      ]
    },
    {
      name: "Box Jump",
      ...
      instructions: [
        "Stand facing a sturdy plyo box at a comfortable distance.",
        "Quarter-squat and swing your arms back to load your hips.",
        "Explode up and land softly on the box in a balanced squat.",
        "Step down one foot at a time to protect your Achilles tendon."
      ]
    },
    {
      name: "Box Step-ups",
      ...
      equipmentCategory: "Plyo Boxes",
      instructions: [
        "Place one foot entirely on the plyo box.",
        "Drive through your heel to bring your other foot up alongside it.",
        "Step down with control, keeping the lead foot on the box for all reps."
      ]
    },
    {
      name: "Box Decline Push-up",
      icon: "Activity",
      pool: "equipment",
      equipmentCategory: "Plyo Boxes",
      instructions: [
        "Place your toes securely on the edge of the plyo box and walk your hands out on the floor into a plank.",
        "Ensure wrists are directly underneath your shoulders and body forms a straight line.",
        "Lower your chest toward the floor by bending your elbows.",
        "Push forcefully back to the starting plank position while maintaining core rigidity."
      ]
    },
    {
      name: "Box Lateral Step Ups",
      icon: "ArrowUp",
      pool: "equipment",
      equipmentCategory: "Plyo Boxes",
      instructions: [
        "Stand sideways next to a plyo box.",
        "Step your inner leg up onto the center of the box.",
        "Drive through that heel to lift your entire body, bringing the outer leg up beside it.",
        "Step down carefully with the outer leg first, maintaining balance."
      ]
    },
    {
      name: "BOSU Push Ups",
      ...
      instructions: [
        "Place the BOSU ball flat-side down or dome-side down for stability challenge.",
        "Position your hands on the sides of the BOSU and assume a plank position.",
        "Lower your body toward the ball and push up under strict stabilization."
      ]
    },
    {
      name: "BOSU Standing Squat",
      icon: "Flame",
      pool: "equipment",
      equipmentCategory: "BOSU Balls",
      instructions: [
        "Carefully step onto the center of the blue dome of the BOSU.",
        "Find your balance, then slowly sit back into a shallow squat.",
        "Hold for a second, then stand up under strict control to fire stabilizer muscles."
      ]
    },
    {
      ...
      equipmentCategory: "BOSU Balls",
      instructions: [
        "Place the BOSU ball flat-side up (black platform facing up).",
        "Grip the handles or outer rim of the platform with both hands and extend your legs into a plank.",
        "Run your legs in and out, drawing your knees toward your chest sequentially.",
        "Keep the BOSU ball completely flat and steady by using your shoulder and core stabilizers."
      ]
    },
    {
      name: "BOSU Boat Pose Balance",
      icon: "Flame",
      pool: "equipment",
      equipmentCategory: "BOSU Balls",
      instructions: [
        "Sit down in the exact sweet spot on the blue dome of the BOSU ball.",
        "Lean back slightly, lift your feet off the floor, and extend your arms outward in front of you.",
        "Balance on your glutes, engaging your core deeply to stave off wobbling.",
        "Hold the position under steady control, breathing slow and smooth."
      ]
    },
    {
      ...
      instructions: [
        "Grip the high or low handles of a loaded sled.",
        "Lean forward at a 45-degree angle, extending your arms fully.",
        "Drive with your legs, taking long, powerful strides to push the sled forward."
      ]
    },
    {
      name: "Sled Drag",
      ...
      equipmentCategory: "Sleds",
      instructions: [
        "Attach a harness or straps to the sled and face the sled holding handles.",
        "Take a low utility stance and walk backward to drag the sled along the turf.",
        "Focus on quad and calf engagement as you move under loaded resistance."
      ]
    },
    {
      name: "Sled High-Incline Walk",
      icon: "TrendingUp",
      pool: "equipment",
      equipmentCategory: "Sleds",
      instructions: [
        "Attach heavy resistance handles to the sled and stand facing away from it.",
        "Hold handles securely on your shoulders or extended in front of you.",
        "Walk forward, leaning into a high posture, pulling the sled behind you with long deliberate steps.",
        "Focus on loading your quads and calves with each high-effort stride."
      ]
    },
    {
      name: "Sled Lateral Pull",
      icon: "ArrowLeftRight",
      pool: "equipment",
      equipmentCategory: "Sleds",
      instructions: [
        "Attach a master rope or strap to the sled and stand sideways to it.",
        "Hold the strap with both hands and bend your knees in a quarter-squat athletic stance.",
        "Cross your trailing leg over the lead leg and step sideways to pull the sled laterally along the floor.",
        "Focus on outer glute power and oblique bracing throughout."
      ]
    }
  ]
};
